        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, благодарим Ви за поръчката!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">Благодарим ви за запазената информация.</h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        ...
                        <br>
                        Вашата пратка е почти на път към вас. Уверете се, че телефонният ви номер е въведен правилно и отговорете на обаждането на нашия мениджър, за да потвърдим детайлите по поръчката Ви.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">Моля, проверете посочената информация за връзка:</h3>
                <div class="list-info">
                    <ul class="list-info__list">
                        <li class="list-info__item">
                            <span class="list-info__text">Телефон: </span>
                            $phone
                        </li>
                    </ul>
                </div>
                <p class="success-page__message_fail">
                    <a class="success-page__message_fail__link" href="javascript:history.back()">
                        Ако сте направили грешка, върнете се и попълнете отново формата.
                    </a>
                </p>
                <h3 class="success-page__text" id="lowerH">
                    За да ускорите оформянето на поръчката ви, попълнете адреса за доставка:
                </h3>
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            <label for="" class="success-page__form__label">Адрес</label>
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> Изпратете </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>Изисква се имейл и/или адрес!</span>" +
